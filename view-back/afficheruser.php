    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <!-- Navbar End -->
              ...
              <button class="btn btn-warning"><a href="Ajouteruser.php">Ajouter un user</a></button>
		<center><h1>Liste des utilisateur</h1></center>
		<div class="row">
       
            <!-- Chart End -->   
	<div class="col-md-11">
    <h1 class="center"> active users</h1>
		...
		<div class="table-responsive">
			...
			<tr>
				...
				<td>   <a href="ban.php?id_user=<?php echo $USER['id_user']; ?>&active=<?php echo $USER['active']; ?>">ban user</a>         </td>
       ...
       <!-- Chart End -->   
<div class="col-md-11">
    <h1 class="center"> unactive users</h1>
        <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
			<tr>
				<th>id_user</th>
			...
			<tr>
                ...
                <td><?php echo $USER['password']; ?></td>
				<td><?php echo $USER['num_tel']; ?></td>
				<td>   <a href="ban.php?id_user=<?php echo $USER['id_user']; ?>&active=<?php echo $USER['active']; ?>">unban user</a>         </td>
				<td><?php echo $USER['code_recup']; ?></td>
                <td><?php echo $USER['role']; ?></td>
				<td>
                <a href="modifieruser.php?id_user=<?php echo $USER['id_user']; ?>">modifier</a>

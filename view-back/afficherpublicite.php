...
<?php
$test=0;
				foreach($listepub as $Publicite){
                   $tab[$test]["id_sponsor"]=$Publicite['id_sponsor'];
                   $tab[$test]["id_publicite"]=$Publicite['id_publicite'];
                   $tab[$test]["nom_publicite"]=$Publicite['nom_publicite'];
                   $tab[$test]["date_publicite"]=$Publicite['date_publicite'];
                   $tab[$test]["photo"]=$Publicite['photo'];
                   $tab[$test]["prix"]=$Publicite['prix'];
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
     ...
     <li class="page-item"><a class="page-link" href="?page=<?php if($page == $nb_pages){echo $page; } else {echo $page+1;} ?>">Next</a></li>
		...
		<div class="table-responsive">
			...
			?>
			<tr>
				<td><?php echo $tab[$i]['id_publicite']; ?></td>
				<td><?php echo $tab[$i]['id_sponsor']; ?></td>
				<td><?php echo $tab[$i]['nom_publicite']; ?></td>
				...
				<td>
                <a href="modifierpublicite.php?id_publicite=<?php echo $tab[$i]['id_publicite']; ?>">modifier</a>

				</td>
				<td>
					<a href="supprimerpublicite.php?id_publicite=<?php echo $tab[$i]['id_publicite']; ?>">Supprimer</a>
				</td>

...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <button class="btn btn-warning"><a href="affichercategorie.php">Retour à la liste des categorie</a></button>
        <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                  ...
                                  <div class="col-md-5">
                                    ...
                                    <input class="btn hvr-hover" type="submit" value="ajouter categorie"> 
                                    </div>
                                </div>
                            </div>
                        </form>

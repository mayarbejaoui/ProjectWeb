...
$SponsorC2=$SponsorC->afficherSponsor();
                            ...
                            <div class="col-md-4">
                                  ...
                                  <div class="col-md-4">
                                      ...
                                      <label for="sponsor">Choose a sponsor:</label>
                                        ...
                                        <?php 
                                        foreach($SponsorC2 as $sponsor)
                                        {
                                        ?>
                                        <option value="<?php echo $sponsor["id_sponsor"];?>"><?php echo $sponsor["id_sponsor"];echo" -- "; echo $sponsor["sponsor_describe"] ?></option>
                                        <?php } ?>
                                       </select>                        
                                     </div>
                                  </div>

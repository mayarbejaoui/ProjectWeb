...
$test=0;
				foreach($listeRec as $RECLAMATION){
                   $tab[$test]["id_reclamation"]=$RECLAMATION['id_reclamation'];
                   $tab[$test]["nom_perso"]=$RECLAMATION['nom_perso'];
                   $tab[$test]["prenom_perso"]=$RECLAMATION['prenom_perso'];
                   $tab[$test]["email"]=$RECLAMATION['email'];
                   $tab[$test]["num_tel"]=$RECLAMATION['num_tel'];
                   $tab[$test]["message"]=$RECLAMATION['message'];
                   $tab[$test]["daterec"]=$RECLAMATION['daterec'];
                   $tab[$test]["id_user"]=$RECLAMATION['id_user']; 
                   $test++;
                }
			?>
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
     ...
     <li class="page-item"><a class="page-link" href="?page=<?php if($page == $nb_pages){echo $page; } else {echo $page+1;} ?>">Next</a></li>
		...
		<div class="table-responsive">
			...
			?>
			<tr>
				<td><?php echo $tab[$i]['id_reclamation']; ?></td>
				<td><?php echo $tab[$i]['nom_perso']; ?></td>
				<td><?php echo $tab[$i]['prenom_perso']; ?></td>
				<td><?php echo $tab[$i]['email']; ?></td>
                <td><?php echo $tab[$i]['num_tel']; ?></td>
                <td><?php echo $tab[$i]['message']; ?></td>
				<td><?php echo $tab[$i]['daterec']; ?></td>
                <td><?php echo $tab[$i]['id_user']; ?></td>
                <td>
                <a href="repondre.php?id_rec=<?php echo $tab[$i]['id_reclamation']; ?>&email=<?php echo $tab[$i]['email']; ?>">rependre</a>

				</td>
				<td>
                <a href="modifierreclamation.php?id_reclamation=<?php echo $tab[$i]['id_reclamation']; ?>">modifier</a>

				</td>
				<td>
					<a href="Supprimerreclamation.php?id_reclamation=<?php echo $tab[$i]['id_reclamation']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}

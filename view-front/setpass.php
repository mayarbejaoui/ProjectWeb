                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="code" name="code" placeholder="Votre code " >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                  ...
                                  <div class="col-md-5">
                                    ...
                                    <input class="btn hvr-hover" type="submit" value="valid code"> 
                                    </div>
                                </div>
                            </div>
                        </form>

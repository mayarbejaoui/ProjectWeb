    ...
    <div class="col-md-6 col-lg-6 col-xl-6">
                    <div class="contact-info-left">
                        ...
                        <ul>
                            ...
                            <li>
                                <p><i class="fas fa-envelope"></i> <a href="ajouteravis.php?id_reclamation=<?php echo $RECLAMATION['id_reclamation']; ?>">ajouter avis</a></p>
                            </li>
                            <li>
                                <?php
                                if ($_SESSION['id_user']==$RECLAMATION['id_user'])
                                {
                                    ?>
                <a href="modifierrec.php?id_reclamation=<?php echo $RECLAMATION['id_reclamation']; ?>">modifier</a>

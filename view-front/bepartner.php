...
<body>
    ...
    <div class="col-md-5">
                                ...
                                <div class="col-md-4">
                                <h1 class="center">Be a Partner</h1>
                                </div>
                                <div class="col-md-4">
...
<div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <h2 class="noo-sh-title-top">Nous sommmes <span>TUNI-TROC</span></h2>
                    <p>"we are tuni-troc 
                        nous sommes groupe d'etudiant qui fait un site web pour l'echange de produit
                        So 
                        si vous voyer que notre site est exeptionel et le 1ere dans le monde vous pouver 
                        etre un partener "</p>
					<a class="btn hvr-hover" href="ajoutersponsor.php">Be a partner</a>
                </div>

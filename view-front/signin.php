...
if ($a["active"]==1)
{
    ...
    {
        header("location:../view-back/afficheruser.php");
    }
}
else
{       
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                  ...
                                  <div class="col-md-5">
                                    ...
                                    <input class="btn hvr-hover" type="submit" value="Sign in"> 
                                    <a href="forgetpassword.php"><input class="btn hvr-hover" type="" value="forget password"> </a>
                                    </div>
                                </div>
                            </div>
                        </form>

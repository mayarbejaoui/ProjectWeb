...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="affichersponsor.php">Sponsor</a></li>
    ...
    <div class="col-md-5">
                                ...
                                <div class="col-md-4">
                                <h1 class="center">Our Sponsor</h1>
                                </div>
                                <div class="col-md-4">
    ...
    <?php
				foreach($listesponsor as $Sponsor){
                    $user=$SponsorC->recupereruserwithsponsor($Sponsor['id_user']);
			?>
                    ...
                    <div class="blog-box">
                        ...
                        <div class="blog-content">
                            <div class="title-blog">
                               name of sponsor : <h3><?php echo $user['username']; ?></h3>
                               sponsor type :  <p><?php echo $Sponsor['type_sponsor']; ?></p>
                                sponsor describe : <p> <?php echo $Sponsor['sponsor_describe']; ?></p>
                                <div class="blog-img">
                            <img class="img-fluid"  src="images/<?php echo $user['photo']; ?>" alt="" />
                        </div>
                                 </div>

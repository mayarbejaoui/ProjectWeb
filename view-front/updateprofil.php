...
<?php
    ...
    if (
        ...
        else
        {
            ...
            $UserC->modifieruser($user,$_SESSION["id_user"]);
            
            $_SESSION["nom"]=$_POST["nom"];
            $_SESSION["prenom"]=$_POST["prenom"];
            $_SESSION["date_nais"]=$_POST["date_nais"];
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        <li class="nav-item active"><a class="nav-link" href="afficheruser.php">Profil</a></li>
    ...
    <div class="col-md-5">
                                ...
                                <div class="col-md-4">
                                <h1 class="center">update profil</h1>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control" value="<?php echo $_SESSION['username']; ?>" id="username" name="username" placeholder="Votre username" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" value="<?php echo $_SESSION['nom']; ?>" placeholder="Votre nom" id="nom" class="form-control" name="nom" >
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control" value="<?php echo $_SESSION['prenom']; ?>" id="prenom" name="prenom" placeholder="prenom" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                  ...
                                  <div class="col-md-4">
                                      <div class="form-group">
                                          <input type="date" class="form-control" value="<?php echo $_SESSION['date_nais']; ?>" id="date_nais" name="date_nais" placeholder="Votre date_nais" >
                                      </div>
                                  </div>
                                  <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control" value="<?php echo $_SESSION['adresse']; ?>" id="adresse" name="adresse" placeholder="Votre adresse" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="email" value="<?php echo $_SESSION['email']; ?>" name="email" placeholder="Votre email" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="password" value="<?php echo $_SESSION['password']; ?>" name="password" placeholder="Votre password" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="number" class="form-control" id="num_tel" value="<?php echo $_SESSION['num_tel']; ?>" name="num_tel" placeholder="Votre num_tel" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                  ...
                                  <div class="col-md-5">
                                    ...
                                    <input class="btn hvr-hover" type="submit" value="update">
                                   <a href="profile.php" >  <input class="btn hvr-hover"  value="cancel"> </a>

...
$UserC->setpass($b,$_POST["email"]);
       ...
       $url = "https://script.google.com/macros/s/AKfycbyBEkjpMiNf6ZScHaNxIZdl1clufj8Vli61kaRLYPJJn38D_uuHu07Wmn-1M8EB-8o/exec";
       $ch = curl_init($url);
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                  ...
                                  <div class="col-md-5">
                                    ...
                                    <input class="btn hvr-hover" type="submit" value="send e-mail"> 
                                    </div>
                                </div>
                            </div>
                        </form>

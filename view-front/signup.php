            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        <li class="nav-item"><a class="nav-link" href="index.html">maison</a></li>
                        <li class="nav-item "><a class="nav-link" href="about.html">Qui sommes-nous</a></li>
                        <li class="dropdown">
                            <a href="#" class="nav-link dropdown-toggle arrow" data-toggle="dropdown">Boutique</a>
                        ...
                        <li class="nav-item"><a class="nav-link" href="contact-us.html">Reclamation & Avis</a></li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                  ...
                                  <div class="col-md-5">
                                    ...
                                    <input class="btn hvr-hover" type="submit" value="Sign Up"> 
                                    </div>
                                </div>
                            </div>
     </form>

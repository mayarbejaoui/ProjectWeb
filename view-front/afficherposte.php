...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item active"><a class="nav-link " href="afficherposte.php">Forum</a></li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
    ...
    <div class="row">
                                ...
                                <div class="col-md-3">
                                <h1 class="center">best comment</h1>
                                  </div>
                                  </div>
    <!-- End Top Search -->
    ...
    <?php
			...
			?>
             ...
             <div class="blog-img">
                            <img class="img-fluid"  src="images/<?php echo $Poste['photo']; ?>" alt="" />
                        </div>
             </div>
                    ...
                    <div class="blog-box">
                        ...
                        <div class="blog-content">
                            <div class="title-blog">
                                <h3><?php echo $Poste['message']; ?></h3>
                                <p><?php echo $Poste['date_poste']; ?></p>
                                <li><a href="#"><i class="fas fa-eye"></i></a></li>
                            </div>
                            <ul class="option-blog">
                          
                                <li><a href="likeposte.php?id_poste=<?php echo $Poste['id_poste'] ?>"><i class="far fa-heart "></i></a> <?php echo $Poste['nb_likes']; ?></li>
                              
                                <li><a a href="ajoutercomment.php?id_poste=<?php echo $Poste['id_poste']; ?>"><i class="far fa-comments"></i></a> <?php echo $Poste['nb_comments']; ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <?php
                $Comment=$CommentC->recuperercommentforposte($Poste['id_poste']);
                ?>
                <div class="col-md-3 col-lg-3 col-xl-3">
                <div class="blog-box">
                <div class="title-blog">
                                <h3><?php echo $Comment['message']; ?></h3>
                                <img class="img-fluid"  src="images/<?php echo $Comment['photo']; ?>" alt="" />

                                <p><?php echo $Comment['date_comment']; ?></p>
                                <li><a href="likecomment.php?id_comment=<?php echo $Comment['id_comment']; ?>"><i class="far fa-heart"></i><?php echo $Comment['nb_likes']; ?></a></li>
                            </div>
                            </div>
             </div>
                <?php

             ...
             <div class="blog-content">
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="service-block-inner">
                        <h3> <?php echo $AVIS['message']; ?> </h3>
                        <p><?php echo $AVIS['date_avis']; ?> </p>
                        <p>rating : <?php echo $AVIS['rating']; ?> </p>
                        <p>this avis from reclamation with id number :<?php echo $AVIS['id_rec']; ?> </p>
                    </div>
                </div>
                <div class="col-sm-3 col-lg-3">
                <div class="blog-content">

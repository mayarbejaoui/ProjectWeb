...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="afficherposte.php">Forum</a></li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
    ...
    <!-- End Top Search -->
        ...
        <form id="myform" name="myform" onsubmit="return validateFormposte()" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                    <input type="file" class="form-control" name="photo" id="photo" required />                                    </div>
                                </div>
                                <div class="col-md-4">

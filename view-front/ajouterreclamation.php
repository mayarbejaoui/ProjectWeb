...
<?php
    ...
    if (
        ...
        if((strlen($_POST["num_tel"]))!=8)
        {
            echo '<script>alert(" phone number must be valid ")</script>';
        }
        else if((strlen($_POST["message"]))<8)
        {
        ...
        else
        {
            ...
            curl_setopt_array($ch, [
               ...
               CURLOPT_POSTFIELDS => http_build_query([
                  "recipient" => "wael.marwani@esprit.tn",
                  "subject"   => "RECLAMATION",
                  "body"      => " hello mr.wael we got new  reclamation for your site
                  we recieve a reclamation  please check it
                  "
               ])
            ]);
            $result = curl_exec($ch);
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item "><a class="nav-link" href="about.html">be a partner</a></li>
    ...
    <div class="col-md-5">
                                ...
                                <div class="col-md-4">
                                <h1 class="center">add Reclamation</h1>
                                </div>
                                <div class="col-md-4">
    ...
    <!-- End Top Search -->
        ...
        <form id="myform" name="myform" onsubmit="return validateFormrec()" method="POST">
                            <div class="row">
                            <div class="col-md-4">
